            ...
            {section name=publika_position loop=$publika}
                <tr>
                    ...
                    <td title="Избриши {$publika[publika_position].datum_id}">
                        <a href="index.php?file_name=delete&table_name=publika&pk_value={$publika[publika_position].datum_id}" type="button" class="btn myBtn"> <i class="fa-solid fa-trash-can"></i></a>
                    </td>
                </tr>
            {/section}
        </tbody>
